 ...
 * @author 84348
 */
@WebServlet(name = "RemoveInventoryVirtualController", urlPatterns = {"/RemoveInventoryVirtualController"})
public class RemoveInventoryVirtualController extends HttpServlet {
