 ...
 * @author 84348
 */
@WebServlet(name = "SeacrhReceiptDetailController", urlPatterns = {"/SeacrhReceiptDetailController"})
public class SeacrhReceiptDetailController extends HttpServlet {

    private static final String ERROR="createSuccessReceipt.jsp";
    private static final String SUCCESS="createSuccessReceipt.jsp";
