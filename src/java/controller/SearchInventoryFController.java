 ...
 * @author 84348
 */
@WebServlet(name = "SearchInventoryFController", urlPatterns = {"/SearchInventoryFController"})
public class SearchInventoryFController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<UserInventory> listInventory = dao.getListSearchInventoryF();
