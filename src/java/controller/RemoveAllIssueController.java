 ...
 * @author 84348
 */
@WebServlet(name = "RemoveAllIssueController", urlPatterns = {"/RemoveAllIssueController"})
public class RemoveAllIssueController extends HttpServlet {

    private static final String ERROR = "MainController?action=SeacrhIssue&seacrhIssue=";
